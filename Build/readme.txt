...
1. Установка необходимого ПО.
	- Скачать и установить 32-РАЗРЯДНУЮ версию nodejs (http://nodejs.org/dist/v0.10.28/node.exe).
	- Скачать и установить Java (http://java.com/ru/download/index.jsp).
	- Скачать и скопировать в "C:\Bin\Google\Closure-compiler" файл compiler.jar (http://dl.google.com/closure-compiler/compiler-latest.zip)
