                            ...
                            else
                            {
                                ...
                                switch( NumSuff )
                                {
                                    ...
                                    case numbering_suff_Space:
                                    {
                                        ...
                                        g_oTextMeasurer.SetTextPr( NumTextPr, this.Get_Theme() );
                                        g_oTextMeasurer.SetFontSlot( fontslot_ASCII );
                                        NumberingItem.WidthSuff = g_oTextMeasurer.Measure( " " ).Width;
                                        g_oTextMeasurer.SetTextPr( OldTextPr, this.Get_Theme() );
                                        break;
                                    }
    ...
    Set_Borders : function(Borders)
    {
        ...
        if ( undefined != Borders.Between )
        {
            ...
            if ( undefined != Borders.Between.Value /*&& border_Single === Borders.Between.Value*/ )
            {
                ...
                NewBorder.Unifill = ( undefined != Borders.Between.Unifill ? Borders.Between.Unifill.createDuplicate() : OldBorders.Between.Value );
            }
        ...
        if ( undefined != Borders.Top )
        {
            ...
            if ( undefined != Borders.Top.Value /*&& border_Single === Borders.Top.Value*/ )
            {
                ...
                NewBorder.Unifill = ( undefined != Borders.Top.Unifill ? Borders.Top.Unifill.createDuplicate() : OldBorders.Top.Value );
        ...
        if ( undefined != Borders.Right )
        {
            ...
            if ( undefined != Borders.Right.Value /*&& border_Single === Borders.Right.Value*/ )
            {
                ...
                NewBorder.Unifill = ( undefined != Borders.Right.Unifill ? Borders.Right.Unifill.createDuplicate() : OldBorders.Right.Value );
        ...
        if ( undefined != Borders.Bottom )
        {
            ...
            if ( undefined != Borders.Bottom.Value /*&& border_Single === Borders.Bottom.Value*/ )
            {
                ...
                NewBorder.Unifill = ( undefined != Borders.Bottom.Unifill ? Borders.Bottom.Unifill.createDuplicate() : OldBorders.Bottom.Value );
            }
        ...
        if ( undefined != Borders.Left  )
        {
            ...
            if ( undefined != Borders.Left.Value /*&& border_Single === Borders.Left.Value*/ )
            {
                ...
                NewBorder.Unifill = ( undefined != Borders.Left.Unifill ? Borders.Left.Unifill.createDuplicate() : OldBorders.Left.Value );
