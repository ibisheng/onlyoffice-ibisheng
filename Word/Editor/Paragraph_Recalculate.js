...
// TODO: 1. Убрать функцию Check_BreakPageInLine, т.к. вместо нее есть LineInfo
// TODO: 2. В быстрых функциях поменять LineInfo->Info, убрать RangeY
...
Paragraph.prototype.private_RecalculateLineBottomBound = function(CurLine, CurPage, PRS, ParaPr)
{
    ...
    var BreakPageLineEmpty = ( true === PRS.BreakPageLine && true === PRS.EmptyLine );
