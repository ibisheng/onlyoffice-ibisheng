...
function CTrackNewObject2(presetGeom, pen, brush, startX, startY, pageIndex)
{
        ...
        else if(!ctrlKey && shiftKey)
        {
            ...
            else
            {
                /* if(_abs_dist_x < MIN_SHAPE_SIZE || _abs_dist_y < MIN_SHAPE_SIZE)
                 ...
                 {
                 this.absExtY = MIN_SHAPE_SIZE;
                 this.absExtX = MIN_SHAPE_SIZE*this.propCoefficient;
                 }
                 else
                 {
                 this.absExtX = MIN_SHAPE_SIZE;
                 this.absExtY = MIN_SHAPE_SIZE*this.invPropCoefficient;
                 }
                 }         */
                //    else
                {
    ...
    this.endTrack = function()
    {
        /*this.originalShape.setAbsoluteTransform(this.posX, this.posY, this.absExtX, this.absExtY, 0, this.flipH, this.flipV);
         this.originalShape.calculateTransformMatrix();*/
      //  this.originalShape.Track_End(this.pageIndex, this.posX, this.posY, this.absExtX, this.absExtY);
    };
