function CreateGeometry(prst, w,  h){
    var f = new Geometry();
    switch(prst){
        ...
        case 'funnel':{
            ...
            f.AddPathCommand(0,undefined, undefined, undefined, undefined, undefined);
            f.AddPathCommand(1, 'x1', 'y1');
            f.AddPathCommand(3, 'hd4', 'wd2', 'stAng1', 'swAng1');
            f.AddPathCommand(2, 'x3', 'y2');
            f.AddPathCommand(3, 'rh3', 'rw3', 'da', 'swAng3');
            f.AddPathCommand(6);
            f.AddPathCommand(1, 'x2', 'hd4');
            f.AddPathCommand(3, 'rh2', 'rw2', 'cd2', '-21600000');
            f.AddPathCommand(6);
            break;
        }
        case 'gear6':{
