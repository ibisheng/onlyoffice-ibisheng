    ...
    if ( false === this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(changestype_Paragraph_Content) )
    {
		...
		switch (Type)
		{
			case 1: 	var oFraction = new CFraction(props);						
						MathElement.CreateFraction(oFraction, MathElement.Root, null, null);
			...
			case 4: 	var oBox = new CBox(props);
						MathElement.CreateElem(oBox, MathElement.Root)
						
						var oElem = oBox.getBase();
						//здесь выставляем для oElem argPr.argSz=-1; этой обертки нет
						var oFraction = new CFraction(props);
						MathElement.CreateFraction(oFraction, oElem, null, null);
						oFraction.fillPlaceholders();
						break;
			case 5: 	var oFraction = new CFraction(props);
						var sNum = "dx";
						var sDen = "dy";
						MathElement.CreateFraction(oFraction,MathElement.Root, sNum, sDen);
						break;
			...
			case 10:	props = {ctrPrp: new CTextPr(), ctrPrp: new CTextPr(), type:DEGREE_SUPERSCRIPT};
						...
						MathElement.CreateDegree(oDegree, MathElement.Root, null, null, null);
			...
			case 14:	props = {ctrPrp: new CTextPr(), type:DEGREE_SUBSCRIPT};			
						var oDegree = new CDegree(props);
						MathElement.CreateElem(oDegree, MathElement.Root)
						...
						MathElement.CreateDegree(oDegree1, oSub, sBase, sSup, null);
						break;
			case 15:	props = {ctrPrp: new CTextPr(), type:DEGREE_SUPERSCRIPT};
						var sBase = "e";
						var sSup = "-i" + String.fromCharCode(969) + "t";						
						var oDegree = new CDegree(props);
						MathElement.CreateDegree(oDegree, MathElement.Root, sBase, sSup, null);
						break;
			...
			case 17:	props = {ctrPrp: new CTextPr(), type:DEGREE_PreSubSup};
						...
						MathElement.CreateDegree(oDegreeSubSup, MathElement.Root, sBase, sSup, sSub);
						break;
			case 18:	props = {ctrPrp: new CTextPr(), type:SQUARE_RADICAL, degHede:true};					
						var oRadical = new CRadical(props);
						MathElement.CreateRadical(oRadical, MathElement.Root, null, null);
			...
			case 20:	props = {ctrPrp: new CTextPr(), type:DEGREE_RADICAL};
						var sDeg = "2";						
						var oRadical = new CRadical(props);
						MathElement.CreateRadical(oRadical, MathElement.Root, null, sDeg);
			...
			case 22:	var oFraction = new CFraction(props);						
						...
						var oRadical = new CRadical(props);
						MathElement.CreateElem(oRadical, oElemNum);						
						var oElem = oRadical.getBase();
						
						props = {ctrPrp: new CTextPr(), type:DEGREE_SUPERSCRIPT};
						var oDegree = new CDegree(props);
						MathElement.CreateElem(oDegree, oElem);						
			...
			case 23:	props = {ctrPrp: new CTextPr(), type:SQUARE_RADICAL, degHede:true};
						var oRadical = new CRadical(props);
						MathElement.CreateElem(oRadical, MathElement.Root);
						...
						var sSup = "2";
						var oDegree1 = new CDegree(props);
						MathElement.CreateDegree(oDegree1, oElem, sBase, sSup, null);
						...
						MathElement.CreateDegree(oDegree2, oElem, sBase, sSup, null);						
						break;
			case 24:	props = {ctrPrp: new CTextPr(), limLoc:NARY_UndOvr, subHide:true, supHide:true};
						var oNary = new CNary(props);
						MathElement.CreateNary(oNary,MathElement.Root,null,null,null);
			...
			case 42:	props = {ctrPrp: new CTextPr(), diff:1};
						...
						MathElement.CreateBox(oBox,MathElement.Root,sVal);
						break;
			...
			case 80:	var sChar = String.fromCharCode(8721);
						props = {ctrPrp: new CTextPr(), /*limLoc:NARY_UndOvr,*/ chr:sChar, supHide:true};
						var oNary = new CNary(props);
						MathElement.CreateElem(oNary,MathElement.Root);
						...
						MathElement.CreateElem(oDelimiter,naryBase);
						var delimiterBase = oDelimiter.getBase(0);
						
						props = {ctrPrp: new CTextPr(), type:NO_BAR_FRACTION};
						var oFraction = new CFraction(props);
						MathElement.CreateFraction(oFraction, delimiterBase, "n", "k");
						break
			case 81:	var sChar = String.fromCharCode(8721);
						props = {ctrPrp: new CTextPr(), chr:sChar/*, limLoc:NARY_UndOvr*/};
						var oNary = new CNary(props);
						MathElement.CreateNary(oNary,MathElement.Root,null,"i=0","n");
						var oElem = oNary.getBase();
						oElem.fillPlaceholders();
						break;
			case 82:	var sChar = String.fromCharCode(8721);
						...
						MathElement.CreateElem(oEqArr, narySub);
			...
			case 83:	var sChar = String.fromCharCode(8719);
						props = {ctrPrp: new CTextPr(), /*limLoc:NARY_UndOvr,*/ chr:sChar};
						var oNary = new CNary(props);
						MathElement.CreateElem(oNary, MathElement.Root);
						...
						MathElement.CreateDegree(oSSub, naryBase, "A", null, "k");
						break;
			case 84:	var sChar = String.fromCharCode(8899);
						...
						MathElement.CreateDegree(oSSub0, delimiterBase, "X", null, "n"); 
						...
						MathElement.CreateDegree(oSSub1, delimiterBase, "Y", null, "n"); 					
						break;
			case 85:	props = {ctrPrp: new CTextPr(), column:1};
						var oDelimiter = new CDelimiter(props);
						MathElement.CreateElem(oDelimiter,MathElement.Root);
			...
			case 119:	props = {ctrPrp: new CTextPr(), column:1, begChr:"{", endChr:""};
						...
						props = {ctrPrp: new CTextPr(), row:2};
						var oEqArr = new CEqArray(props);
						MathElement.CreateElem(oEqArr,oElem);
			...
			case 123:	MathElement.AddText(MathElement.Root, "f");
						...
						MathElement.CreateElem(oDelimiter1,MathElement.Root);
						...
						MathElement.CreateElem(oDelimiter2,MathElement.Root);
						var del2Elem = oDelimiter2.getBase(0);
						
						props = {ctrPrp: new CTextPr(), row:2};
						var oEqArr = new CEqArray(props);
						MathElement.CreateElem(oEqArr, del2Elem);
			...
			case 124:	props = {ctrPrp: new CTextPr(), column:1};
						...
						props = {ctrPrp: new CTextPr(), type:NO_BAR_FRACTION};
						var oFraction = new CFraction(props);
						MathElement.CreateFraction(oFraction,oElem,"n","k");
						break;
			...
			case 126:	var oFunc = new CMathFunc(props);
						MathElement.CreateElem(oFunc,MathElement.Root);
			...
			case 132:	var oFunc = new CMathFunc(props);
						...
						var sSup = "-1";
						var oDegree = new CDegree(props);
						MathElement.CreateDegree(oDegree, oFName, sBase, sSup, null);	
						var oElem = oFunc.getArgument();
						oElem.fillPlaceholders();						
						break;
			...
			case 153:	var sChr = String.fromCharCode(775);
						...
						MathElement.CreateElem(oAcc,MathElement.Root);
			...
			case 164:	var sChr = String.fromCharCode(9182);
						...
						MathElement.CreateElem(oGroupChr,MathElement.Root);
			...
			case 166:	props = {ctrPrp: new CTextPr(), type:LIMIT_UP};
						...
						MathElement.CreateElem(oLimUpp,MathElement.Root);
						...
						props = {ctrPrp: new CTextPr(), chr:sChr, pos:VJUST_TOP, vertJc:VJUST_BOT};
						oGroupChr = new CGroupCharacter(props);
						MathElement.CreateElem(oGroupChr,oElem);
			...
			case 167:	props = {ctrPrp: new CTextPr(), type:LIMIT_LOW};
						...
						MathElement.CreateElem(oLimLow,MathElement.Root);
			...
			case 173:	var oBorderBox = new CBorderBox(props);
						MathElement.CreateElem(oBorderBox,MathElement.Root);
			...
			case 174:	var oBorderBox = new CBorderBox(props);
						...
						MathElement.CreateDegree(oDegree0, oElem, "a", "2", null);
						MathElement.AddText(oElem, "=");
						var oDegree1 = new CDegree(props);
						MathElement.CreateDegree(oDegree1, oElem, "b", "2", null);
						MathElement.AddText(oElem, "+");
						var oDegree2 = new CDegree(props);
						MathElement.CreateDegree(oDegree2, oElem, "c", "2", null);					
						break;
			case 175:	props = {ctrPrp: new CTextPr(), pos:LOCATION_TOP};
						var oBar = new CBar(props);
						MathElement.CreateElem(oBar,MathElement.Root);
			...
			case 180:	var oFunc = new CMathFunc(props);
						...
						props = {ctrPrp: new CTextPr(), type:DEGREE_SUBSCRIPT};
						var oSSub = new CDegree(props);
						MathElement.CreateElem(oSSub, oFName);
			...
			case 182:	var oFunc = new CMathFunc(props);
						...
						var oLimLow = new CLimit(props);
						MathElement.CreateElem(oLimLow, oFName);						
			...
			case 186:	var oFunc = new CMathFunc(props);
						...
						props = {ctrPrp: new CTextPr(), column:1};
						var oDelimiter = new CDelimiter(props);
						MathElement.CreateElem(oDelimiter,degreeElem);
			...
			case 187:	var oFunc = new CMathFunc(props);
						...
						MathElement.CreateElem(supSup, oSup);
			...
			case 209:	props = {ctrPrp: new CTextPr(), column:2, row:1, mcJc:"center"};
						...
						MathElement.CreateElem(oMatrix,MathElement.Root);
			...
			case 225:	props = {ctrPrp: new CTextPr(), column:1};
						...
						var oMatrix = new CMathMatrix(props);
						MathElement.CreateElem(oMatrix,delimiterBase);
						oMatrix.fillPlaceholders();
						break;
