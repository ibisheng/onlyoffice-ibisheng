			...
			else
			{
				...
				if (StartPos != EndPos)
				{
					...
					if (true != bStartEmpty && true != bEndEmpty)
					{
						...
						{
							if (true === bOnTextAdd && type_Table === this.Content[StartPos + 1].GetType() && type_Table === this.Content[StartPos].Get_ype())
							{
							...
							else if (true === bOnTextAdd && type_Table === this.Content[StartPos + 1].GetType())
							{
								this.CurPos.ContentPos = StartPos;
			...
			if (type_Paragraph == this.Content[this.CurPos.ContentPos].GetType())
			{
				...
				if (false === this.Content[this.CurPos.ContentPos].Remove(Count, bOnlyText))
				{
					...
					else if (Count > 0)
					{
						...
						{
							if (true === this.Is_TrackRevisions() && reviewtype_Add !== this.Content[this.CurPos.ContentPos].GetReviewType())
							{
