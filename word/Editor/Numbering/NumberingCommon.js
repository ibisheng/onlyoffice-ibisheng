...
CLvlText_Text.prototype.Copy = function()
{
	return new CLvlText_Text(this.Value);
};
CLvlText_Text.prototype.Write_ToBinary = function(Writer)
{
...
CLvlText_Text.prototype.Read_FromBinary = function(Reader)
{
...
CLvlText_Num.prototype.Copy = function()
{
	return new CLvlText_Num(this.Value);
};
CLvlText_Num.prototype.Write_ToBinary = function(Writer)
{
	// Long : numbering_lvltext_Text
	// Long : Value
...
CLvlText_Num.prototype.Read_FromBinary = function(Reader)
{
