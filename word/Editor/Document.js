...
CDocument.prototype.RemoveContentControl = function(Id)
{
	...
	if (AscCommon.sdttype_BlockLevel === oContentControl.GetContentControlType() && oContentControl.Parent)
	{
		this.RemoveSelection();
...
CDocument.prototype.ClearContentControl = function(Id)
{
	...
	if (oContentControl.GetContentControlType
		&& (AscCommon.sdttype_BlockLevel === oContentControl.GetContentControlType()
		|| AscCommon.sdttype_InlineLevel === oContentControl.GetContentControlType()))
	{
