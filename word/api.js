...
background-repeat: no-repeat;\
		...
		if (this.HtmlElement != null)
			this.HtmlElement.innerHTML = "<div id=\"id_main\" class=\"block_elem\" style=\"-ms-touch-action: none;-moz-user-select:none;-khtml-user-select:none;user-select:none;background-color:" + AscCommonWord.GlobalSkin.BackgroundColor + ";overflow:hidden;\" UNSELECTABLE=\"on\">\
								<div id=\"id_panel_left\" class=\"block_elem\">\
									...
									<div id=\"id_vertical_scroll\" style=\"left:0;top:0px;width:10px;overflow:hidden;position:absolute;\">\
									...
									<div id=\"id_horizontal_scroll\" style=\"left:0px;top:0;height:10px;overflow:hidden;position:absolute;width:100%;\">\
	...
	/**
	 * test code for insert watermark
	 * wang xu ming
	 */
	asc_docs_api.prototype.InsertWaterMark = function( text, options )
	{
		if (!this.WordControl.m_oLogicDocument)
			return;
