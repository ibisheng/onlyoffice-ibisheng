...
//для сохранения в историю и пересылки изменений
	...
	UndoRedoData_GTableIdAdd.prototype.Properties = {
		objectType: 0, id: 1
	};
	UndoRedoData_GTableIdAdd.prototype.getType = function () {
		return UndoRedoDataTypes.GlobalTableIdAdd;
	};
	UndoRedoData_GTableIdAdd.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoData_GTableIdAdd.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoData_GTableIdAdd.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.objectType: {
	...
	UndoRedoData_historyitem_Paragraph_AddItem.prototype.Properties = {
		startPos: 0, endPos: 1, itemsIds: 2
	};
	UndoRedoData_historyitem_Paragraph_AddItem.prototype.getType = function () {
		return UndoRedoDataTypes.ParagraphParaItemAdd;
	};
	UndoRedoData_historyitem_Paragraph_AddItem.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoData_historyitem_Paragraph_AddItem.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoData_historyitem_Paragraph_AddItem.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.startPos: {
				this.startPos = value;
				break;
	...
	UndoRedoDataDocContentAddItem.prototype.Properties = {
		pos: 0, objectId: 1
	};
	UndoRedoDataDocContentAddItem.prototype.getType = function () {
		return UndoRedoDataTypes.DocContentAddItem;
	};
	UndoRedoDataDocContentAddItem.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataDocContentAddItem.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataDocContentAddItem.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.pos: {
				this.pos = value;
				break;
	...
	UndoRedoDataTypeParaItemId.prototype.Properties = {
		itemId: 0
	};
	UndoRedoDataTypeParaItemId.prototype.getType = function () {
		return UndoRedoDataTypes.DocContentParaItemId;
	};
	UndoRedoDataTypeParaItemId.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataTypeParaItemId.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataTypeParaItemId.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.itemId: {
				this.itemId = value;
				break;
	...
	UndoRedoDataAddParaItem.prototype.Properties = {
		type: 0, value: 1
	};
	UndoRedoDataAddParaItem.prototype.getType = function () {
		return UndoRedoDataTypes.ParagraphAddParaItem;
	};
	UndoRedoDataAddParaItem.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddParaItem.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataAddParaItem.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.type: {
				this.type = value;
				break;
	...
	UndoRedoDataDocContentRemoveItems.prototype.Properties = {
		pos: 0, aItems: 1
	};
	UndoRedoDataDocContentRemoveItems.prototype.getType = function () {
		return UndoRedoDataTypes.DocContentRemoveItems;
	};
	UndoRedoDataDocContentRemoveItems.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataDocContentRemoveItems.prototype.getProperty = function (nType) {
		switch (nType) {
			case this.Properties.pos:
				return this.pos;
	...
	UndoRedoDataDocContentRemoveItems.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.pos: {
				this.pos = value;
				break;
	...
	UndoRedoDataParaPr.prototype.Properties = {
		ContextualSpacing: 0, IndLeft: 1, // Левый отступ
		...
		BrdBetween: 17, BrdBottom: 18, BrdLeft: 19, BrdRight: 20, BrdTop: 21, WidowControl: 22, // Запрет висячих строк
		Tabs: 23, // Заданные табы
		NumPr: 24, // Нумерация
		PStyle: 25 // Стиль параграфа
	};
	UndoRedoDataParaPr.prototype.getType = function () {
		return UndoRedoDataTypes.SheetPositions;
	};
	UndoRedoDataParaPr.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataParaPr.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataParaPr.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.ContextualSpacing       :
	...
	UndoRedoDataGraphicObjects.prototype.Properties = {
		objectId: 0, drawingData: 1
	};
	UndoRedoDataGraphicObjects.prototype.getType = function () {
		return UndoRedoDataTypes.GraphicObjects;
	};
	UndoRedoDataGraphicObjects.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataGraphicObjects.prototype.getProperty = function (nType) {
		switch (nType) {
			case this.Properties.objectId:
				return this.objectId;
	...
	UndoRedoDataGraphicObjects.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.objectId:
				this.objectId = value;
				break;
	...
	function UndoRedoDataGOPairProps(oldValue1, oldValue2, newValue1, newValue2) {
		this.Properties = {
			oldValue1: 0, oldValue2: 1,

			newValue1: 2, newValue2: 3
		};
	...
	UndoRedoDataGOPairProps.prototype.getType = function () {
		return UndoRedoDataTypes.GOPairProps;
	};
	UndoRedoDataGOPairProps.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataGOPairProps.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataGOPairProps.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.oldValue1:
	...
	UndoRedoDataGOSingleProp.prototype.getType = function () {
		return UndoRedoDataTypes.GOSingleProp;
	};
	UndoRedoDataGOSingleProp.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataGOSingleProp.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataGOSingleProp.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.oldValue:
				this.oldValue = value;
				break;
	...
	UndoRedoDataShapeRecalc.prototype.getType = function () {
		return UndoRedoDataTypes.GOShapeRecalcTransform;
	};
	UndoRedoDataShapeRecalc.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataShapeRecalc.prototype.getProperty = function (nType) {
		return null;
	};
	UndoRedoDataShapeRecalc.prototype.setProperty = function (nType, value) {
	};
	...
	UndoRedoDataAddAdjustment.prototype.getType = function () {
		return UndoRedoDataTypes.GOAddAdjustment;
	};
	UndoRedoDataAddAdjustment.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddAdjustment.prototype.getProperty = function (nType) {
		switch (nType) {
			case this.Properties.name:
				return this.name;
			case this.Properties.val:
	...
	UndoRedoDataAddAdjustment.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.name:
				this.name = value;
				break;
	...
	UndoRedoDataAddGuide.prototype.getType = function () {
		return UndoRedoDataTypes.GOAddGuide;
	};
	UndoRedoDataAddGuide.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddGuide.prototype.getProperty = function (nType) {
		switch (nType) {
			case this.Properties.name:
				return this.name;
			case this.Properties.formula:
	...
	UndoRedoDataAddGuide.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.name:
				this.name = value;
				break;
	...
	UndoRedoDataAddCnx.prototype.getType = function () {
		return UndoRedoDataTypes.GOAddCnx;
	};
	UndoRedoDataAddCnx.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddCnx.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataAddCnx.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.ang:
				this.ang = value;
				break;
	...
	function UndoRedoDataAddHandleXY(gdRefX, minX, maxX, gdRefY, minY, maxY, posX, posY) {
		this.Properties = {
			gdRefX: 0, minX: 1, maxX: 2,

			gdRefY: 3, minY: 4, maxY: 5, posX: 6, posY: 7
		};
	...
	UndoRedoDataAddHandleXY.prototype.getType = function () {
		return UndoRedoDataTypes.GOHandleXY;
	};
	UndoRedoDataAddHandleXY.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddHandleXY.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataAddHandleXY.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.gdRefX:
				this.gdRefX = value;
				break;
	...
	function UndoRedoDataAddHandlePolar(gdRefR, minR, maxR, gdRefAng, minAng, maxAng, posX, posY) {
		this.Properties = {
			gdRefR: 0, minR: 1, maxR: 2,

			gdRefAng: 3, minAng: 4, maxAng: 5, posX: 6, posY: 7
		};
	...
	UndoRedoDataAddHandlePolar.prototype.getType = function () {
		return UndoRedoDataTypes.GOHandlePolar;
	};
	UndoRedoDataAddHandlePolar.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddHandlePolar.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataAddHandlePolar.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.gdRefR:
				this.gdRefR = value;
				break;
	...
	function UndoRedoDataAddPathCommand(command, x1, y1, x2, y2, x3, y3) {
		this.Properties = {
			command: 0, x1: 1, y1: 2, x2: 3, y2: 4, x3: 5, y3: 6
		};
	...
	UndoRedoDataAddPathCommand.prototype.getType = function () {
		return UndoRedoDataTypes.GOAddPathCommand;
	};
	UndoRedoDataAddPathCommand.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddPathCommand.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataAddPathCommand.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.command:
				this.command = value;
				break;
	...
	UndoRedoDataAddObject.prototype.getType = function () {
		return UndoRedoDataTypes.GOAddObject;
	};
	UndoRedoDataAddObject.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddObject.prototype.getProperty = function (nType) {
		switch (nType) {
			case this.Properties.objectId:
				return this.objectId;
		}
	...
	UndoRedoDataAddObject.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.objectId:
				this.objectId = value;
				break;
	...
	UndoRedoDataAddGeometryRect.prototype.getType = function () {
		return UndoRedoDataTypes.GOAddGeometryRect;
	};
	UndoRedoDataAddGeometryRect.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataAddGeometryRect.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataAddGeometryRect.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.l:
				this.l = value;
				break;
	...
	UndoRedoDataMoveToLineTo.prototype.getType = function () {
		return UndoRedoDataTypes.GOPathLineToMoveTo;
	};
	UndoRedoDataMoveToLineTo.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataMoveToLineTo.prototype.getProperty = function (nType) {
		switch (nType) {
			case this.Properties.x:
				return this.x;
			case this.Properties.y:
	...
	UndoRedoDataMoveToLineTo.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.x:
				this.x = value;
				break;
	...
	UndoRedoDataArcTo.prototype.getType = function () {
		return UndoRedoDataTypes.GOPathArcTo;
	};
	UndoRedoDataArcTo.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataArcTo.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataArcTo.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.wR:
				this.wR = value;
				break;
	...
	UndoRedoDataQuadBezTo.prototype.getType = function () {
		return UndoRedoDataTypes.GOPathQuadBezTo;
	};
	UndoRedoDataQuadBezTo.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataQuadBezTo.prototype.getProperty = function (nType) {
		switch (nType) {
	...
	UndoRedoDataQuadBezTo.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.x0:
				this.x0 = value;
				break;
	...
	UndoRedoDataCubicBezTo.prototype.getType = function () {
		return UndoRedoDataTypes.GOPathCubicBezTo;
	};
	UndoRedoDataCubicBezTo.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataCubicBezTo.prototype.getProperty = function (nType) {
		switch (nType) {
			case this.Properties.x0:
				return this.x0;
			case this.Properties.y0:
	...
	UndoRedoDataCubicBezTo.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.x0:
				this.x0 = value;
				break;
	...
	UndoRedoDataClosePath.prototype.getType = function () {
		return UndoRedoDataTypes.GOPathClose;
	};
	UndoRedoDataClosePath.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataClosePath.prototype.getProperty = function (nType) {
		return null;
	};
	UndoRedoDataClosePath.prototype.setProperty = function (nType, value) {

	};
	var g_oUndoRedoDataSetAdjustmentValueProperties = {
		gdName: 0, oldVal: 1, newVal: 2
	};
	...
	UndoRedoDataSetAdjustmentValue.prototype.getType = function () {
		return UndoRedoDataTypes.GOSetAdjustmentValue;
	};
	UndoRedoDataSetAdjustmentValue.prototype.getProperties = function () {
		return this.Properties;
	};
	UndoRedoDataSetAdjustmentValue.prototype.getProperty = function (nType) {
	...
	UndoRedoDataSetAdjustmentValue.prototype.setProperty = function (nType, value) {
		switch (nType) {
			case this.Properties.gdName:
				this.gdName = value;
				break;
