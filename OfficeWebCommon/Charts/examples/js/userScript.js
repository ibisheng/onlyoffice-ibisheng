...
function formatDraw(value,fTitle)
{
	...
	var name = '#'+value;
	$(name).dialog({
		title: fTitle.innerText,    //тайтл, заголовок окна
		width:550,              //ширина
		height: 550,            //высота
...
function insertOptions()
{
	...
	//задаём значения по Y
	
	//addOptions('chart.numyticks',parseInt((yFirstMax -yFirstMin)/yFirstDiff));//увеличиваем промежуточные деления
...
function drawDiagram1()
{
	...
	//bar._otherProps._xaxispos = 'center';
        ...
        //высота области для осей неверна, нужно вводить параметр(но пока так)
...
$(function(){
	...
	$(".getMainName").click(function()
	{
		...
		{
			bar._chartTitle._text = 'Название диаграммы';
	...
	$(".getNameAxes").click(function()
	{
		...
		else if('mNOXYHorUp' == id)
		{
			...
			{
				//calcGutter('OX');
				bar._xAxisTitle._text = 'Название оси';
				calcAllMargin();
		...
		else if('mNOXYVerCon' == id)
		{
			...
			{*/
				//calcGutter('OY');
			bar._yAxisTitle._text = 'Название оси';
	...
	$(".lineMainSelect").click(function(){
		...
		var massiveDefault = ['null','Название диаграммы;1','Название диаграммы;null','null','Название оси X','null','Название оси Y','Название оси Y','Название оси Y','null',"['ряд1']","['ряд1']",defaultMas,defaultMas,'false','true','true','true','true','true','tableBase','tableBase','tableBase','null',temMass,temMass,temMass,'false','true','true','true','true','true','null','true','true','true','null','true','true'];
	...
	$(".optionsDiffIntAY").click(function(){
		...
		alert('интервал между значениями по OX отсутсвует')
	});
...
function changeDiagram(value)
{
	...
	if(valueSize == '1')
	{
		addOptions('chart.title','название диаграммы');
		addOptions('chart.title.xaxis','название оси X');
		addOptions('chart.title.yaxis','название оси Y');
	}
	else if(valueSize == '2')
	{
		addOptions('chart.title','название диаграммы');
