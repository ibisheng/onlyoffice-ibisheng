...
$("#shapeOffsetX,#shapeOffsetY, #shapeRectX, #shapeRectY,#shapeColor, #shapeAlpha, #shapeRotation, #shapeShadowColor, #shapeShadowLength,#shapeShadowAngle, #shapeLineColor, #shapeLineWeight, #shapeShadowAlpha,#shapeTop,#shapeLeft,#imgW, #imgH, #imgLeft, #imgTop, #imgRight, #imgBottom, #imgX, #imgY, #hafHF, #tblW, #tblCS, #tblMarLeft, #tblMarTop, #tblMarRight, #tblMarBottom, #tblIndentLeft, #tblLeft, #tblTop, #tblRight, #tblBottom, #tblBrdSize, #tblBrdColor, #tblBrdBGColor, #imgURL, #tblCellBrdSize, #tblCellBrdColor, #tblCellBrdSize, #tblCellBrdColor, #tblCellBrdBGColor, #tblDefMarLeft, #tblDefMarTop, #tblDefMarRight, #tblDefMarBottom, #tblX, #tblY, #prFirst, #prLeft, #prRight, #prLineHeight, #prAfter, #prBefore").focus(function(){
	editor.enableKeyEvents(false);
}).blur(function(){editor.enableKeyEvents(true);})
...
case "mnuSaveAsDocx":
	$('#mainmenu').trigger('closemenu');
	editor.DownloadAs(c_oAscFileType.DOCX);
	break;
case "mnuSaveAsDoc":
	$('#mainmenu').trigger('closemenu');
	editor.DownloadAs(c_oAscFileType.DOC);
	break;
case "mnuSaveAsRtf":
	$('#mainmenu').trigger('closemenu');
	editor.DownloadAs(c_oAscFileType.RTF);
	break;
case "mnuSaveAsPdf":
	$('#mainmenu').trigger('closemenu');
	editor.DownloadAs(c_oAscFileType.PDF);
	break;
case "mnuAbout":
	$('#mainmenu').trigger('closemenu');
...
//to init api callbacks in test menu
 setTimeout(function(){
	...
	editor.registerCallback("asc_onPrAlign", function(){
	...
	editor.registerCallback("asc_onListType", function(){
	...
	editor.registerCallback("asc_onClearPropObj", function(){
	...
	editor.registerCallback("asc_onHeadersAndFootersProp", function(){
		$("#hafProp").show();
	...
	editor.registerCallback("asc_onFocusObject", function(){
		var arg = arguments[0];
	...
	editor.registerCallback("asc_onSaveUrl", function(){
	...
	$("#tblApply").click(function(){
     ...
     $("#shapePrpApply").click(function(){
        var Prop = {};
         ...
         if(Bits!=null)
            Prop.fill_color = new CColor1(Bits[1], Bits[2], Bits[3]);
         else
            Prop.fill_color=0;
         ...
         if(Bits!=null)
            Prop.line_color = new CColor1(Bits[1], Bits[2], Bits[3]);
         else
            Prop.line_color = 0;
         ...
         Prop.shadow.color = new CColor1(Bits[1], Bits[2], Bits[3]);
