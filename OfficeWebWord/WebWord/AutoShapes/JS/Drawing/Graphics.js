...
function CGraphics(){
    ...
    this._m = function(x,y){
        ...
        {
            var _x = parseInt(this.m_oFullTransform.TransformPointX(x/100,y/100)/* + 0.5*/);
            var _y = parseInt(this.m_oFullTransform.TransformPointY(x/100,y/100)/* + 0.5*/);
    ...
    this._c = function(x1,y1,x2,y2,x3,y3){
        ...
        {
            var _x1 = parseInt(this.m_oFullTransform.TransformPointX(x1/100,y1/100)/* + 0.5*/);
            var _y1 = parseInt(this.m_oFullTransform.TransformPointY(x1/100,y1/100)/* + 0.5*/);

            var _x2 = parseInt(this.m_oFullTransform.TransformPointX(x2/100,y2/100)/* + 0.5*/);
            var _y2 = parseInt(this.m_oFullTransform.TransformPointY(x2/100,y2/100)/* + 0.5*/);

            var _x3 = parseInt(this.m_oFullTransform.TransformPointX(x3/100,y3/100)/* + 0.5*/);
            var _y3 = parseInt(this.m_oFullTransform.TransformPointY(x3/100,y3/100)/* + 0.5*/);
            this.m_oContext.bezierCurveTo(_x1/100+ 0.5,_y1/100+ 0.5,_x2/100+ 0.5,_y2/100+ 0.5,_x3/100+ 0.5,_y3/100+ 0.5);
        }

    }
     this._c2 = function(x1,y1,x2,y2){
         if (false === this.m_bIntegerGrid)
            this.m_oContext.quadraticCurveTo(x1/100,y1/100,x2/100,y2/100);
        else
        {
            var _x1 = parseInt(this.m_oFullTransform.TransformPointX(x1/100,y1/100)/* + 0.5*/);
            var _y1 = parseInt(this.m_oFullTransform.TransformPointY(x1/100,y1/100)/* + 0.5*/);
            ...
            this.m_oContext.quadraticCurveTo(_x1/100+ 0.5,_y1/100+ 0.5,_x2/100+ 0.5,_y2/100+ 0.5);
        }
    }
    this.ds = function(){
    ...
    this.transform2=function(sx,shy,shx,sy,tx,ty)
    {
        if (false)
        {
            var matr = new CMatrix();
            matr.sx    = sx;
            matr.shx   = shx;
            matr.shy   = shy;
            matr.sy    = sy;
            ...
            this.m_oTransform.Multiply(matr, MATRIX_ORDER_APPEND);
        ...
        {
            this.m_oContext.transform(sx,shy,shx,sy,tx, ty);
        }
    };
    this.transform3=function(m)
    {
